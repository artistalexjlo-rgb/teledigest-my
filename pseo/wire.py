...
# Ниже порога — плитки нет: не вешаем ложное обещание. Правило простое и живёт здесь,
# а не ссылкой: «СКОРО» показываем, только когда данных под тему уже набралось.
THRESHOLD = 25
